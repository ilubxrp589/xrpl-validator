//! DepositPreauth byte-exact vectors (bundle-driven).
//!
...
#[test]
fn deposit_preauth_entry_carries_flags_and_its_owner_directory_node() {
    run_bundle(include_str!("vectors/deposit_preauth_entry_carries_flags_and_owner_node_106737708.json"));
}

/// Finding 132, second specimen (#106737754 EDF9D55A): rJqiMb94 authorizes
/// r3mSX4Gy, the same shape. Three targets byte-pinned.
#[test]
