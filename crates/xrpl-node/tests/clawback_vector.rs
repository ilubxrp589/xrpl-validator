//! Byte-exact vector drills for Clawback (2026-09-21).
//!
...
/// Finding 351 — devnet #5489422 953947B4: a Clawback from an issuer that
/// never set lsfAllowTrustLineClawback. Clawback::preclaim answers
/// tecNO_PERMISSION before reading the line (Clawback.cpp:108); we read
/// the line first and applied the clawback.
#[test]
