//! Byte-exact vector drills for AMMDelete (2026-09-20).
//!
...
/// Finding 347 — testnet campaign 6, #20910502 E11CE295: AMMDelete on the
/// USD/XRP pool while its LP tokens are all outstanding. rippled's preclaim
/// answers tecAMM_NOT_EMPTY (fee only); we deleted the AMM object and took
/// an owner count off its creator. AMMDelete had never run anywhere before
/// this campaign.
#[test]
fn amm_delete_of_a_pool_with_lp_tokens_is_not_empty_testnet_20910502() {
    run_bundle(include_str!("vectors/amm_delete_of_a_pool_with_lp_tokens_is_not_empty_testnet_20910502.json"));
}
